  ...
  implements Runnable
{
  public void run()
  {
    ...
    float f1 = ((SmartRefreshLayout)localObject1).o00oOOOO;
    ...
    localObject1 = this.o00Ooo0O.o00ooO0;
    localObject2 = new com/scwang/smartrefresh/layout/SmartRefreshLayout$9$1;
    ((SmartRefreshLayout.9.1)localObject2).<init>(this);
    ((ValueAnimator)localObject1).addUpdateListener((ValueAnimator.AnimatorUpdateListener)localObject2);
    localObject1 = this.o00Ooo0O.o00ooO0;
    localObject2 = new com/scwang/smartrefresh/layout/SmartRefreshLayout$9$2;
    ((SmartRefreshLayout.9.2)localObject2).<init>(this);
 ...
 * Qualified Name:     com.scwang.smartrefresh.layout.SmartRefreshLayout.9
