...
class FadeModeEvaluators
{
  ...
  static
  {
    Object localObject = new com/google/android/material/transition/platform/FadeModeEvaluators$1;
    ((FadeModeEvaluators.1)localObject).<init>();
    IN = (FadeModeEvaluator)localObject;
    localObject = new com/google/android/material/transition/platform/FadeModeEvaluators$2;
    ((FadeModeEvaluators.2)localObject).<init>();
    OUT = (FadeModeEvaluator)localObject;
    localObject = new com/google/android/material/transition/platform/FadeModeEvaluators$3;
    ((FadeModeEvaluators.3)localObject).<init>();
    CROSS = (FadeModeEvaluator)localObject;
    localObject = new com/google/android/material/transition/platform/FadeModeEvaluators$4;
