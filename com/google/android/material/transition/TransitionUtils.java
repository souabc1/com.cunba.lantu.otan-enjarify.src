...
class TransitionUtils
{
  ...
  {
    OooO00o localOooO00o = new com/google/android/material/transition/OooO00o;
  ...
  public static ShapeAppearanceModel lerp(ShapeAppearanceModel paramShapeAppearanceModel1, ShapeAppearanceModel paramShapeAppearanceModel2, RectF paramRectF1, RectF paramRectF2, float paramFloat1, float paramFloat2, float paramFloat3)
  {
    ...
    TransitionUtils.1 local1 = new com/google/android/material/transition/TransitionUtils$1;
  ...
  public static void maybeAddTransition(TransitionSet paramTransitionSet, Transition paramTransition)
  {
    if (paramTransition != null) {
      paramTransitionSet.OooOo0o(paramTransition);
    }
  }
  ...
  {
    if (paramTransition != null) {
      paramTransitionSet.OooOooO(paramTransition);
    }
  }
  ...
  public static PathMotion resolveThemePath(Context paramContext, int paramInt)
  {
    ...
    if (bool)
    {
      ...
      if (j == k)
      {
        ...
        if (j == i)
        {
          paramContext = new com/google/android/material/transition/MaterialArcMotion;
          paramContext.<init>();
          return paramContext;
        }
      ...
      if (j == paramInt)
      {
        ...
        localObject2 = new androidx/transition/PatternPathMotion;
