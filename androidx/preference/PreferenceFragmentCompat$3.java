  ...
  implements Runnable
{
  public void run()
  {
    ...
    {
      localObject2 = new androidx/preference/PreferenceFragmentCompat$ScrollToPreferenceObserver;
      localObject3 = this.o00Ooo0.o00Ooo0;
      Preference localPreference = this.o00OoOoo;
      String str = this.o00Ooo00;
      ((PreferenceFragmentCompat.ScrollToPreferenceObserver)localObject2).<init>((RecyclerView.Adapter)localObject1, (RecyclerView)localObject3, localPreference, str);
 ...
 * Qualified Name:     androidx.preference.PreferenceFragmentCompat.3
