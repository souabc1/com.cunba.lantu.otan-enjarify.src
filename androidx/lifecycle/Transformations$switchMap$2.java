...
public final class Transformations$switchMap$2
  implements Observer
{
  ...
  {
    paramObject = (LiveData)this.OooO0O0.apply(paramObject);
    ...
    if (paramObject != null)
    {
      ...
      localObject2 = new androidx/lifecycle/Transformations$switchMap$2$onChanged$1;
      Object localObject3 = this.OooO0OO;
      ((Transformations.switchMap.2.onChanged.1)localObject2).<init>((MediatorLiveData)localObject3);
 ...
 * Qualified Name:     androidx.lifecycle.Transformations.switchMap.2
