...
{
  public KeyFrameArray.CustomArray OooOO0o;
  public float[] OooOOO;
  ...
  {
    KeyFrameArray.CustomArray localCustomArray = this.OooOO0o;
    int i = localCustomArray.OooO0o0();
    CustomAttribute localCustomAttribute = this.OooOO0o.OooO0o(0);
    int j = localCustomAttribute.OooO0Oo();
    ...
    while (m < i)
    {
      ...
      ((CustomAttribute)localObject2).OooO0O0(arrayOfFloat3);
      n = 0;
      arrayOfFloat3 = null;
      for (;;)
      {
