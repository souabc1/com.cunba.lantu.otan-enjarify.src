...
public class TypedBundle
{
  ...
  public void OooO0o(TypedValues paramTypedValues)
  {
    int i = 0;
    int j = 0;
    int[] arrayOfInt = null;
    ...
    for (;;)
    {
      ...
      paramTypedValues.OooO0OO(k, (String)localObject2);
      j += 1;
    }
    for (;;)
    {
      ...
      k = localObject1[i];
      paramTypedValues.OooO0Oo(j, k);
      i += 1;
    }
  }
  
  public void OooO0o0(TypedBundle paramTypedBundle)
  {
    int i = 0;
    int j = 0;
    int[] arrayOfInt = null;
    ...
    for (;;)
    {
      ...
      k = localObject1[j];
      localObject2 = this.OooO0oo[j];
      paramTypedBundle.OooO0OO(k, (String)localObject2);
      j += 1;
    }
    for (;;)
    {
