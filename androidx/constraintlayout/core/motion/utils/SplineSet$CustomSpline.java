...
public class SplineSet$CustomSpline
  extends SplineSet
{
  public KeyFrameArray.CustomVar OooO0o;
  ...
  {
    this.OooO0o.OooO00o(paramInt, paramCustomVariable);
  }
  
  public void setup(int paramInt)
  {
    KeyFrameArray.CustomVar localCustomVar = this.OooO0o;
    ...
    while (k < i)
    {
      ...
      ((CustomVariable)localObject2).OooO0O0(arrayOfFloat2);
      m = 0;
      arrayOfFloat2 = null;
      for (;;)
      {
