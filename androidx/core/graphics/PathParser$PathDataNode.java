...
public class PathParser$PathDataNode
{
  ...
  {
    char c = paramPathDataNode.OooO00o;
    this.OooO00o = c;
    paramPathDataNode = paramPathDataNode.OooO0O0;
    int i = paramPathDataNode.length;
    paramPathDataNode = PathParser.OooO0OO(paramPathDataNode, 0, i);
    this.OooO0O0 = paramPathDataNode;
  }
  ...
  public static void OooO0OO(Path paramPath, float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, float paramFloat5, float paramFloat6, float paramFloat7, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if (bool1)
    {
      ...
      f1 = (float)(Math.sqrt(d3) / 1.99999D);
    ...
    d9 = d11 - d16;
    d3 = d5 - d14;
    d11 = Math.atan2(d9, d3);
    d8 -= d16;
    d10 -= d14;
    double d20 = Math.atan2(d8, d10) - d11;
    boolean bool3 = d20 < d15;
    boolean bool4;
    if (!bool3)
    {
      bool4 = true;
    ...
    d7 = d11;
    d11 = d20;
    OooO0O0(paramPath, d22, d23, d12, d4, d21, d2, d1, d7, d20);
  }
  
  public static void OooO0o0(PathDataNode[] paramArrayOfPathDataNode, Path paramPath)
  {
    int i = 6;
    ...
    for (;;)
    {
      ...
      Object localObject = paramArrayOfPathDataNode[j];
      char c2 = ((PathDataNode)localObject).OooO00o;
      localObject = ((PathDataNode)localObject).OooO0O0;
      OooO00o(paramPath, arrayOfFloat, c1, c2, (float[])localObject);
      PathDataNode localPathDataNode = paramArrayOfPathDataNode[j];
      c1 = localPathDataNode.OooO00o;
      j += 1;
    }
  }
  
  public void OooO0Oo(PathDataNode paramPathDataNode1, PathDataNode paramPathDataNode2, float paramFloat)
  {
    int i = paramPathDataNode1.OooO00o;
    this.OooO00o = i;
    i = 0;
    for (;;)
    {
      float[] arrayOfFloat1 = paramPathDataNode1.OooO0O0;
      int j = arrayOfFloat1.length;
      if (i >= j) {
        break;
      }
      float[] arrayOfFloat2 = this.OooO0O0;
      float f1 = arrayOfFloat1[i];
      float f2 = 1.0F - paramFloat;
      f1 *= f2;
      float[] arrayOfFloat3 = paramPathDataNode2.OooO0O0;
